...
def screen(picks: list[dict]) -> list[dict]:
    ...
    response = client.messages.create(
        ...
        system=(
            ...
            "or the market being stale versus news. Additionally VETO: markets "
            "whose resolution depends on interpretive wording ('announced', "
            "'confirmed', 'widely reported') rather than an objective numeric "
            "source, and single-entity announcement markets where an informed "
            "counterparty could know the outcome (adverse selection — ask who "
            "is selling this favorite and why). Default to OK — false "
